      ...
      {showDeactivateAccount && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="mb-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                      You can reactivate it anytime by logging in again. Your data will remain intact.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2 mb-4 ml-4">
                <li className="flex items-start">
                  ...
                  <span>Your profile won't be visible to others</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>You won't receive notifications</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>You can't post or interact with content</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
            ...
            <form onSubmit={handleDeactivateAccountSubmit}>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:focus:ring-indigo-600"
                    placeholder="Enter your password"
                    required
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:focus:ring-indigo-600"
                    placeholder="Help us understand why you're leaving temporarily..."
                    rows="3"
                  />
                </div>
                {deactivateError && (
                ...
                <div className="flex space-x-3 pt-2">
                  <button
                    type="button"
                    onClick={handleDeactivateAccountCancel}
                    className="flex-1 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-lg bg-yellow-600 hover:bg-yellow-700 disabled:bg-yellow-400 text-white font-medium transition-colors duration-200"
                  >
